  ...
  return (
    <div className=" mx-auto px-4 py-8 p-6 md:p-10">
      <Helmet>
        ...
        <meta name="description" content="Privacy Policy of vectrium Ventures" />
      </Helmet>
    
      <h1 className="text-4xl font-bold mb-4">Privacy Policy</h1>
      <p className="text-gray-600 mb-6">Last updated: September 17, 2024</p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        <a href="/" target="_blank" rel="noopener noreferrer" className='text-[#ca8a04]'>
          Privacy Policy 
        </a>.
      </p>
      ...
      <h3 className="text-2xl font-semibold mt-6 mb-2">Interpretation</h3>
      <p className="mb-4">
        The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
      </p>

      <h3 className="text-2xl font-semibold mt-6 mb-2">Definitions</h3>
      ...
      <ul className="list-disc pl-5 space-y-2">
        ...
        <li>
          <strong>Company</strong> (referred to as either the Company, We, Us or Our in this Agreement) refers to vectrium Ventures.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to vectrium Ventures, accessible from{' '}
          <a href="/" rel="external nofollow noopener" target="_blank" className='text-[#ca8a04]'>
            https://info@epoojastore.in  
          </a>
        </li>
        <li>
      ...
      <h3 className="text-2xl font-semibold mt-6 mb-2">Types of Data Collected</h3>
      ...
      <ul className="list-disc pl-5 space-y-2">
        ...
        <li>
          ...
          <p>Type: Persistent Cookies</p>
          <p>Administered by: Us</p>
          <p>Purpose: These Cookies allow us to remember choices You make when You use the Website, such as remembering your login information or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid having to re-enter your preferences every time You use the Website.</p>
        </li>
      </ul>
      <p className="mb-4">
      ...
      <h2 className="text-3xl font-semibold mt-8 mb-4">Use of Your Personal Data</h2>
      <p className="mb-4">
...
<h3 className="text-2xl font-semibold mt-6 mb-2">Retention of Your Personal Data</h3>
...
<h3 className="text-2xl font-semibold mt-6 mb-2">Transfer of Your Personal Data</h3>
...
<h3 className="text-2xl font-semibold mt-6 mb-2">Delete Your Personal Data</h3>
...
<h3 className="text-2xl font-semibold mt-6 mb-2">Disclosure of Your Personal Data</h3>
...
<h3 className="text-2xl font-semibold mt-6 mb-2">Security of Your Personal Data</h3>
...
<ul className="list-disc pl-5 space-y-2">
<li>
<p className="mb-4">By email: contact@info@epoojastore.in</p>
</li>
<li>
<p className="mb-4">By visiting this page on our website: <a href="/" rel="external nofollow noopener" target="_blank" className='text-[#ca8a04]'>https://info@epoojastore.in/</a></p>
</li>
</ul>
